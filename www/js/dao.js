...
var configURLLogin = {
	...
	dadosEstados: {"cod_plano": ""},
	exibeTipoServico: false,
	dadosCarteira: {"matricula": "", "sequencial": 1, "token": ""},
	dadosGrupoFamiliar: {"matricula": "", "token": ""},
	dadosMunicipio: {"cod_estado": ""},
	dadosTipoServico: {"cod_municipio": "", "cod_estado": ""},
	dadosServicos: {"cod_plano": "", "cod_estado": "", "cod_municipio": "", "cod_modalidade": ""},
	dadosDetalheCredenciado: {"cpf_cnpj": "", "seq": ""},
...
function runtimePopup(header, message, notBack,callback) {
	...
	var template = "<div data-role='popup' id='popupDialog' data-overlay-theme='a' data-theme='c' class='pop-up-tamanho ui-corner-all messagePopup'>"
	+ "<div data-role='header' data-theme='a' class='pop-up-header ui-corner-top' >"
	+ "<h1>" + header + "</h1>"
	+ "</div>"
	+ "<div data-role='content' data-theme='d' class='ui-corner-bottom ui-content' style = 'margin: 15px;'>"
	+ "<h3 class='ui-title'>" + message + "</h3>"
	+ "<a href='#' data-role='button' data-inline='true' data-rel='back' class = 'pop-up-botao1' > OK </a>"
	+ "</div>";
...
function runtimePopupCall(header, tel) {
	...
	var template = "<div data-role='popup' id='popupDialog3' data-overlay-theme='a' data-theme='c' class='pop-up-tamanho ui-corner-all messagePopup'>"
	+ "<div data-role='header' data-theme='a' class='pop-up-header ui-corner-top' id='title-operadora'>"
	+ "<h1>" + header + "</h1>"
	+ "</div>"
	+ "<div data-role='content' data-theme='d' class='ui-corner-bottom ui-content' style = 'margin: 15px;'>"
	+ "<div data-role='fieldcontain'  id='bairroFiltro' class='espaco input-no-padding'>"
	+ "<input required placeholder='Ex: 21' type='text' id='dddinput' value='' class='espaco'>"
	+ "</div>"
	+ "<a href='#' data-role='button' data-inline='true' class = 'pop-up-botao-okinput' > OK </a>"
	+ "</div>";
...
function runtimePopupConfirm(header, message, callback) {
	...
	var template = "<div data-role='popup' id='popupDialog2' data-overlay-theme='a' data-theme='c' class='pop-up-tamanho ui-corner-all messagePopup'>"
	+ "<div data-role='header' data-theme='a' class='pop-up-header ui-corner-top' >"
	+ "<h1>" + header + "</h1>"
	+ "</div>"
	+ "<div data-role='content' data-theme='d' class='ui-corner-bottom ui-content' style = 'margin: 15px;'>"
	+ "<h3 class='ui-title'>" + message + "</h3>"
	+ "<a href='#' data-role='button' data-inline='true' class = 'pop-up-ok' > Sim </a>"
	+ "<a href='#' data-role='button' data-inline='true' data-rel='back' class = 'pop-up-cancelar' > Não </a>"
	+ "</div>";
